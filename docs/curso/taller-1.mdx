...
**Qué problema resuelve:** un ingeniero que ejecuta tareas ya especificadas, pero nunca practicó decidir qué construir antes de que alguien más lo defina por él.
...
- **Product builder** — dueño de punta a punta: decide, construye, responde por el resultado
...
22 candidatos reales, agrupados por a quién sirven.
