...
- Los 5 criterios de priorización, extraídos del [product brief de Buildwise](/proyecto/brief) y documentados en [`docs/proyecto/priorizacion.md`](/proyecto/priorizacion).
