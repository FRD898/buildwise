...
- **Decisión en clase:** servidor MCP. El plan era dejarla anotada sin decidir (CA-4 de `docs/specs/taller-2-contenido.md`), pero se decidió en vivo. Las razones dadas en clase: sirve mejor para enseñar, una skill no se actualiza sola, y sirve más contenido (esta última no se sostiene: una skill también puede traer varios archivos). El detalle está en el ADR [Distribuir el contenido del curso como servidor MCP](https://github.com/FRD898/buildwise/blob/main/docs/adrs/distribuir-como-servidor-mcp.md).
